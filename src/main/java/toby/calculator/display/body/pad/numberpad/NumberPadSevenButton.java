...
@Component
public class NumberPadSevenButton extends PadButton
{
    @Autowired
    public NumberPadSevenButton(final CalculatorInputLine calculatorInputLine)
    {
    ...
    {
        button.setText(CalculatorSymbol.SEVEN.getSymbolDisplay());
    }

    @Override
    public void inputSymbol(final ActionEvent event)
    {
        super.inputSymbol(CalculatorSymbol.SEVEN.getSymbolDisplay());
    }
}
