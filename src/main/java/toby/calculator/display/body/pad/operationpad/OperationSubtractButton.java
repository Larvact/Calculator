...
@Component
public class OperationSubtractButton extends PadButton
{
    @Autowired
    public OperationSubtractButton(final CalculatorInputLine calculatorInputLine)
    {
    ...
    {
        button.setText(CalculatorSymbol.SUBTRACT.getSymbolDisplay());
    }

    @Override
    public void inputSymbol(final ActionEvent event)
    {
        super.inputSymbol(CalculatorSymbol.SUBTRACT.getSymbolDisplay());
    }
}
