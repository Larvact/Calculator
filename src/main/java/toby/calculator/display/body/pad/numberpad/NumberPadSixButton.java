...
@Component
public class NumberPadSixButton extends PadButton
{
    @Autowired
    public NumberPadSixButton(final CalculatorInputLine calculatorInputLine)
    {
    ...
    {
        button.setText(CalculatorSymbol.SIX.getSymbolDisplay());
    }

    @Override
    public void inputSymbol(final ActionEvent event)
    {
        super.inputSymbol(CalculatorSymbol.SIX.getSymbolDisplay());
    }
}
