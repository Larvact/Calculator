...
@Component
public class NumberPadOneButton extends PadButton
{
    @Autowired
    public NumberPadOneButton(final CalculatorInputLine calculatorInputLine)
    {
    ...
    {
        button.setText(CalculatorSymbol.ONE.getSymbolDisplay());
    }

    @Override
    public void inputSymbol(final ActionEvent event)
    {
        super.inputSymbol(CalculatorSymbol.ONE.getSymbolDisplay());
    }
}
